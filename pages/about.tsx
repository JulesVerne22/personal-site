  ...
  return <Box sx={{ width: '100%', textAlign: 'center' }}>
    ...
    >
      <Container
        maxWidth='lg'
        disableGutters={true}
        sx={{ padding: '0px 15px 50px' }}
      >
        <Image
          src='/images/TravelImage.png'
          alt='Travel Image'
          height='100'
          width='300'
        />
    ...
    <Box sx={{ backgroundColor: 'primary.main', padding: '50px 0px' }}>
      ...
      >
        ...
        >
          I enjoy indoor rock climbing, fitness, and video games. 
          My free time is spent working on computer projects. 
          My passions are learning and creation.
        </Typography>
      </Container>
    </Box>
  </Box>
